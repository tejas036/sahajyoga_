    ...
    <div class="main-content">
        ...
        <div class="form-row">
                <label>
                    ...
                    <select style="width:580px" type="text" class="tow" name="towards" id="towards" required>
                        <option value="" disabled selected>--select--</option>
                        <option value="International Sahaja Yoga Seminar, Ganpatipule 2022">International Sahaja Yoga Seminar, Ganpatipule 2022</option>
            ...
            <label>
                <span> From Date</span>
                <input type="text" disabled value="mm/dd/yyyy"  name="fdatef" id="fdatef" class="inputdate"  onchange="getAmount(),checkDateFromfood()">
            </label>
            <label>
               <span>To Date</span> 
                ...
                <input type="text" disabled value="mm/dd/yyyy"  name="tdatef" id="tdatef" class="inputdate" onchange="getAmount(), checkDateTofood()">
            </label>
              ...
              <label>
                <span> From Date</span>
                <input type="text" disabled value="mm/dd/yyyy"  name="fdates" id="fdates" class="inputdate"  onchange="getAmount(),checkDateFromStay()">
            </label>
            <label >
               <span>To Date</span> 
                <!-- <input type="date" onchange="date('fdatef','tdatef','rate','FoodContAmount'), getGrandTotal(), getAmount()"  name="tdatef" id="tdatef" class="inputdate"> -->
                <input type="text" disabled value="mm/dd/yyyy"  name="tdates" id="tdates" class="inputdate" onchange="getAmount(), checkDateToStay()">
            </label>
            </div>
            <br>
             ...
             <div class="form-row">
                <label id="tb_part_1">
                    <label>
                     ...
                     <label>
                       <span>Gender *</span>
                       <select name="part_gender" style="width: 100px;" id="part_gender">
                       <option value=""></option>
...
$(function() {
        ...
        datesToBeDisabled = ["2022-12-23","2022-12-24","2022-12-25","2022-12-26"];
