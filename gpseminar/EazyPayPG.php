...
// $from_f_d = strtotime("2010-01-20"); // or your date as well
// $to_f_d = strtotime("2010-01-31");
// $date_diff_food = $to_f_d - $from_f_d;
// $day_food = round($datediff / (60 * 60 * 24));
// $day_food = $day_food + 1;
// if($from_f_d < $to_f_d) {
//    
// }
...
$status = "pending";
    ...
    $sql = "INSERT INTO `event_food`(`fname`, `lname`, `mobile`, `email`, `pan`, `aadhar`, `pin`, `part_name`, `part_gender`, `part_city`, `transaction_id`, `amount`, `status`, `transaction_start_time`,`towards`, `who_im`, `fromdatefood`, `todatefood`, `food`, `fromdatestay`, `todatestay`, `stay`, `time`) 
    VALUES ('$payerFirstName','$payerLastName','$payerContact','$payerEmail','$panNumber','$aadhar','$pin','$partName', '$partGender','$partCity','$trans_id','$amount','$status','$date','$towards','event_food', '$fromDateFood','$toDateFood','$foodAmount','$fromDateStay','$toDateStay','$stayAmount','$time')";
    echo $sql;
