...
$backToForm = 'https://www.sahajayogamumbai.org/nirmaldhamaradgaon/index.php';
//echo $id;
$Date =  date("Y-m-d");
...
if ($result->num_rows > 0) {
    ...
    while ($row = $result->fetch_assoc()) {
        ...
        $couponQuery = "SELECT coupon_number,name,gender FROM `participants_rahuri` where event_registration_id=$eventRegId";
          ...
          >
            <div class="heading">
              <div class="row">
                ...
                >
                  <h6>
                  <b id="cphead">
                    Your payment for Maharashtra Yuva Shakti Seminar - 2023, Aradgaon (Rahuri) <?php echo $payment_for ?> is SUCCESSFUL as per below details
                    </b>
                  </h6>
                </div>
              </div>
            ...
            <div class="table-responsive" style="padding: 5px 20px 5px 20px">
              <table class="table table-bordered table-bg-color">
                ...
                <tbody>
                  <tr>
                    <th style="width:400px">Participant's Name</th>
