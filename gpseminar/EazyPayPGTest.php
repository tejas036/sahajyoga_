...
$status = "pending";
    ...
    $sql = "INSERT INTO `event_food`(`fname`, `lname`, `mobile`, `email`, `pan`, `aadhar`, `pin`, `part_name`, `part_gender`, `part_city`, `transaction_id`, `amount`, `status`, `transaction_start_time`,`towards`, `who_im`, `fromdatefood`, `todatefood`, `food`, `fromdatestay`, `todatestay`, `stay`, `time`,`category`) 
    VALUES ('$payerFirstName','$payerLastName','$payerContact','$payerEmail','$panNumber','$aadhar','$pin','$partName', '$partGender','$partCity','$trans_id','$amount','$status','$date','$towards','event_food', '$fromDateFood','$toDateFood','$foodAmount','$fromDateStay','$toDateStay','$stayAmount','$time','$partCategory')";
    echo $sql;
