...
<head>
    ...
    <title>International Sahaja Yoga Seminar, Ganapatipule, 2023</title>
...
<div class="main-content">
    ...
    <form class="form-basic" method="post" name="myForm" action="EazyPayPGevent.php" id="formfield"
        ...
        <div class="form-title-row">
            <h2 style="text-align: center;">The Life Eternal Trust, Mumbai</h2>
            <h3 style="text-align: center;">International Sahaja Yoga Seminar, Ganapatipule</h3>
            <h4 style="text-align: center;">December 22-26, 2023</h4>
    ...
    while ($row = mysqli_fetch_assoc($resultEvent)) {
      $eventId = $row['event_id'];
        ...
        $sql = "SELECT * FROM events_new where form_name = 'event' and event_id !=3";
        ...
        ?>
                ...
                var radioValue = $("input[name='contriRadio']:checked").val();
                  ...
                  if(y > x)
                 {
                    if(radioValue == 'International Sahaja Yoga Seminar, Ganapatipule')
                            {
                 ...
                 else
                 {
                    if(radioValue == 'International Sahaja Yoga Seminar, Ganapatipule')
                            ...
                            {
                            finalTotalAmountAdult =  1300 * num;  
                            }
                 }
                ...
                var radioValue = $("input[name='contriRadio']:checked").val();
                 ...
                 else
                 {
                    if(radioValue == 'International Sahaja Yoga Seminar, Ganapatipule')
                            ...
                            {
                                finalTotalAmountChild =  1300 * num; 
                            }
                 }
...
function addRowsadult() {
    ...
    for (var i = 0; i < cellCount; i++) {
        ...
        if (rowCount == 1) {
            ...
            cell.id = 'adult2';
            var copycel =
                '<select style="width:200px !important" class="eventtable ustate" '+ 'onchange="dist(this)"' +' id="adult_city" name="adult_city[]" value=""> </select>';
            cell.innerHTML = copycel;
            cell = row.insertCell(3);
            cell.id = 'adult3';
            var copycel =
                '<select style="width:170px !important" class="eventtable dist"  id="adult_centre" name="adult_centre[]" value=""> </select>';
            cell.innerHTML = copycel;
...
function addRowsyuva() {
    ...
    for (var i = 0; i < cellCount; i++) {
        ...
        if (rowCount == 1) {
            ...
            cell.id = 'yuva2';
            var copycel =
                '<select style="width:200px !important" class="eventtable ustate" '+ 'onchange="dist(this)"' +' id="yuva_city" name="yuva_city[]" value=""> </select>';
            cell.innerHTML = copycel;
            cell = row.insertCell(3);
            cell.id = 'yuva3';
            var copycel =
                '<select style="width:170px !important" class="eventtable dist"  id="yuva_centre" name="yuva_centre[]" value=""> </select>';
            cell.innerHTML = copycel;
            //cell = row.insertCell(4);
            //cell.id = 'yuva4';
            //var copycel =
...
function addRowschild() {
    ...
    for (var i = 0; i < cellCount; i++) {
        ...
        if (rowCount == 1) {
            ...
            cell.id = 'child2';
            var copycel =
                '<select style="width:200px !important" class="eventtable ustate" '+ 'onchange="dist(this)"' +'  id="child_city" name="child_city[]" value=""> </select>';
            cell.innerHTML = copycel;
            cell = row.insertCell(3);
            cell.id = 'child3';
            var copycel =
                '<select style="width:170px !important" class="eventtable dist"  id="child_centre" name="child_centre[]" value=""> </select>';
            cell.innerHTML = copycel;
            //cell = row.insertCell(4);
            //cell.id = 'child4';
...
function checkAdult() {
    ...
    for (index = 0; index < document.getElementById("number_adult1").value; index++) {
        ...
        if (adultCentre[index].value == "") {
            alert("Please select adult's district");
            //errorFlag=true;
...
function checkYuva() {
    ...
    for (index = 0; index < document.getElementById('number_yuva1').value; index++) {
        ...
        if (yuvaCentre[index].value == '') {
            alert("Please select yuva's district");
            //errorFlag=true;
...
function checkChild() {
    ...
    for (index = 0; index < document.getElementById('number_child1').value; index++) {
        ...
        if (childCentre[index].value == '') {
            alert("Please select child's district");
            //errorFlag=true;
...
// var classname = document.getElementsByClassName("ustate");
// console.log(classname[0].addEventListener('change',function nilesh(){
//     console.log("Nilesh");
// }));
...
function dist(docs){
    states = document.getElementsByClassName('ustate');
    console.log(states[0]);
    var uindex=indexInClass(states,docs);
    dist = document.getElementsByClassName('dist')[uindex];
