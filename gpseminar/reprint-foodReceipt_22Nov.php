...
$sql1 = "select * from event_food where transaction_id = '$id'";
...
$breakfast = $row1['breakfast'];
$lunch = $row1['lunch'];

$dinner = $row1['dinner'];
$fulldayMeal = $row1['fullday_meal'];
$stay = $row1['stay'];

}
 
$food_amt = (float)$breakfast + (float)$lunch + (float)$dinner + (float)$fulldayMeal;
$stay_amt = (float)$stay;
  
 $tdate=date_create($transDate,timezone_open("Asia/Kolkata"));
 $tjDate =  date_format($tdate,"jS M Y");
 $fdatef=date_create($fromDate,timezone_open("Asia/Kolkata"));
 $tdatet=date_create($toDate,timezone_open("Asia/Kolkata"));
...
<DOCTYPE html >
		...
		#t3_1{left:290px;bottom:706px;letter-spacing:-0.23px;word-spacing:0.02px; font-weight: bold; font-size:30px}
		#t4_1{left:150px;bottom:686px;letter-spacing:-0.08px; }
		#t5_1{left:170px;bottom:666px;letter-spacing:-0.08px;}
		#t6_1{left:210px;bottom:646px;letter-spacing:-0.08px;}
		#t7_1{left:245px;bottom:626px;letter-spacing:-0.08px;}
		#t8_1{left:49px;bottom:533px;letter-spacing:0.12px;word-spacing:0.11px;}
		#t9_1{left:160px;bottom:533px;letter-spacing:0.17px; }
		#ta_1{right:42px;bottom:533px;letter-spacing:0.08px;word-spacing:0.04px;}
		#tb_1{right:80px;bottom:533px;letter-spacing:0.16px; }
		#tc_1{left:49px;bottom:493px;letter-spacing:0.13px;word-spacing:0.01px;}
		#td_1{right:520px;bottom:493px;letter-spacing:0.25px;word-spacing:-0.03px; }
		#te_1{left:49px;bottom:453px;letter-spacing:0.13px;word-spacing:-0.05px;}
		#tf_1{left:140px;bottom:453px;letter-spacing:0.21px; }
		...
		#tap{right:45px;bottom:125px;letter-spacing:0.17px; }
		...
		#tw_2{left:232px;bottom:40px;letter-spacing:-0.09px;word-spacing:0.03px;color: darkgray;}

		#tx_1{left:55px;bottom:120px;letter-spacing:0.13px;border: 1px solid black ;padding:0px 55px 0px 5px;font-weight:bold; font-size:22px}
		...
		<div id="tc_1" class="t s4">Received with thanks from : ________________________________________________________________</div>
		...
		<div id="tg_1" class="t s4">Tel. No. : _______________________________</div>
		<div id="th_1" class="t s5"> <?php echo $mobile ?></div>

		<div id="ti_1" class="t s4">PAN No. : ________________________________________</div>
		...
		<div id="taa" class="t s4">Food Contribution (From : _________________________</div>
		<div id="tab" class="t s5"> <?php echo date_format($fdatef,"jS M Y") ?></div>
		<div id="tac" class="t s4">To : ____________)</div>
		<div id="tad" class="t s5">  <?php echo date_format($tdatet,"jS M Y") ?></div>
		<div id="tae" class="t s4">Rs : ___________________</div>
		<div id="taf" class="t s5"> <?php echo $food_amt ?> /- </div>

		<div id="tag" class="t s4">Stay Contribution (From : _________________________</div>
		<div id="tah" class="t s5">   <?php echo date_format($fdatef,"jS M Y") ?></div>
		<div id="tai" class="t s4">To : ____________)</div>
		<div id="taj" class="t s5">  <?php echo date_format($tdatet,"jS M Y") ?></div>
		<div id="tak" class="t s4">Rs : ___________________</div>
		<div id="tal" class="t s5">  <?php echo $stay_amt ?>/- </div>
