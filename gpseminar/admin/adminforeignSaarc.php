...
?>
          ...
          <div class="col-md-12" align="center">
            ...
            <div class="col-md-12" style="padding-bottom: 10px;">
                <a href="adminonline.php" class="btn-sm btn btn-info">Online Dashboard </a>
                <a href="adminoffline.php" class="btn-sm btn btn-info">Offline Digital Dashboard</a>
                <a href="admincash.php" class="btn-sm btn btn-info">Offline Cash Dashboard</a>
                <a href="adminforeign.php" class="btn-sm btn btn-info">Foreign Digital (NON-SAARC) Dashboard</a>
                <a href="adminforeignSaarc.php" class="btn-sm btn btn-success">Foreign Digital (SAARC) Dashboard</a>
              </div>
              <br>

          <?php
          $Date =  date("Y-m-d");
          $sql = "SELECT count(*) as totalTransanction, sum(Amount) as totalAmount FROM event_registration where status = 'Success' and paymenttype ='foreign_sarc' ";
          ...
          where ereg.status = 'success' and ereg.paymenttype ='foreign_sarc'";
          ...
          join event_registration ereg
          on part.event_registration_id= ereg.event_registration_id
          where ereg.status = 'success' and part.gender='Male' and ereg.paymenttype ='foreign_sarc'";
          ...
          join event_registration ereg
          on part.event_registration_id= ereg.event_registration_id
          where ereg.status = 'success' and part.gender='Female' and ereg.paymenttype ='foreign_sarc'";
    ...
    join event_registration ereg
    on part.event_registration_id= ereg.event_registration_id
    where part.participant_type='Adult' and ereg.status = 'success' and ereg.paymenttype ='foreign_sarc'";
    ...
    join event_registration ereg
    on part.event_registration_id= ereg.event_registration_id
    where part.participant_type='Adult' and ereg.status = 'success' and part.gender='Male' and ereg.paymenttype ='foreign_sarc'";
    ...
    join event_registration ereg
    on part.event_registration_id= ereg.event_registration_id
    where part.participant_type='Adult' and ereg.status = 'success' and part.gender='Female' and ereg.paymenttype ='foreign_sarc'";
    ...
    join event_registration ereg
    on part.event_registration_id= ereg.event_registration_id
    where part.participant_type='Yuva' and ereg.status = 'success' and ereg.paymenttype ='foreign_sarc'";
    ...
    join event_registration ereg
    on part.event_registration_id= ereg.event_registration_id
    where part.participant_type='Yuva' and ereg.status = 'success' and part.gender='Male' and ereg.paymenttype ='foreign_sarc'";
    ...
    join event_registration ereg
    on part.event_registration_id= ereg.event_registration_id
    where part.participant_type='Yuva' and ereg.status = 'success' and part.gender='Female' and ereg.paymenttype ='foreign_sarc'";
    ...
    join event_registration ereg
    on part.event_registration_id= ereg.event_registration_id
    where part.participant_type='Child' and ereg.status = 'success' and ereg.paymenttype ='foreign_sarc'";
    ...
    join event_registration ereg
    on part.event_registration_id= ereg.event_registration_id
    where part.participant_type='Child' and ereg.status = 'success' and part.gender='Male' and ereg.paymenttype ='foreign_sarc'";
    ...
    join event_registration ereg
    on part.event_registration_id= ereg.event_registration_id
    where part.participant_type='Child' and ereg.status = 'success' and part.gender='Female' and ereg.paymenttype ='foreign_sarc'";
    ...
    $Date =  date("Y-m-d");
		$sql = "SELECT count(*) as totalTransanction, sum(Amount) as totalAmount FROM event_registration where Transaction_start_time='" . $Date. "' and status = 'Success' and paymenttype ='foreign_sarc'";
    ...
    join event_registration ereg
    on part.event_registration_id= ereg.event_registration_id
    where part.participant_type='Adult' and ereg.status = 'success' and ereg.Transaction_start_time='$Date' and ereg.paymenttype ='foreign_sarc'";
    ...
    join event_registration ereg
    on part.event_registration_id= ereg.event_registration_id
    where part.participant_type='Adult' and ereg.status = 'success' and ereg.Transaction_start_time='$Date' and part.gender='Male' and ereg.paymenttype ='foreign_sarc'";
    ...
    join event_registration ereg
    on part.event_registration_id= ereg.event_registration_id
    where part.participant_type='Adult' and ereg.status = 'success' and ereg.Transaction_start_time='$Date' and part.gender='Female' and ereg.paymenttype ='foreign_sarc'";
    ...
    join event_registration ereg
    on part.event_registration_id= ereg.event_registration_id
    where part.participant_type='Yuva' and ereg.status = 'success' and ereg.Transaction_start_time='$Date' and ereg.paymenttype ='foreign_sarc'";
    ...
    join event_registration ereg
    on part.event_registration_id= ereg.event_registration_id
    where part.participant_type='Yuva' and ereg.status = 'success' and ereg.Transaction_start_time='$Date' and part.gender='Male' and ereg.paymenttype ='foreign_sarc'";
    ...
    join event_registration ereg
    on part.event_registration_id= ereg.event_registration_id
    where part.participant_type='Yuva' and ereg.status = 'success' and ereg.Transaction_start_time='$Date' and part.gender='Female' and ereg.paymenttype ='foreign_sarc'";
    ...
    join event_registration ereg
    on part.event_registration_id= ereg.event_registration_id
    where part.participant_type='Child' and ereg.status = 'success' and ereg.Transaction_start_time='$Date' and ereg.paymenttype ='foreign_sarc'";
    ...
    join event_registration ereg
    on part.event_registration_id= ereg.event_registration_id
    where part.participant_type='Child' and ereg.status = 'success' and ereg.Transaction_start_time='$Date' and part.gender='Male' and ereg.paymenttype ='foreign_sarc'";
    ...
    join event_registration ereg
    on part.event_registration_id= ereg.event_registration_id
    where part.participant_type='Child' and ereg.status = 'success' and ereg.Transaction_start_time='$Date' and part.gender='Female' and ereg.paymenttype ='foreign_sarc'";
