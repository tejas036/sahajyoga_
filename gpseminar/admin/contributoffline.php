...
<div class="col-md-12" style="padding-bottom: 10px;">
                ...
                <a href="contributoffline.php" class="btn-sm btn btn-success">Offline Digital Payment MIS Report</a>
				   ...
				   $yesterdayDate = "2023-10-20";
					...
					if(!empty($_POST["search"])) {
						...
						if (!empty($mobile))
						   ...
						   $queryCondition .= " WHERE ".implode(" AND " , $andParts)." and paymenttype ='offline' and Payment_mode !='Cash'";
					 ...
					 $sql = "SELECT * from event_registration WHERE Status = 'Success' and paymenttype ='offline' and Payment_mode !='Cash' and Transaction_start_time between '$yesterdayDate' and '$todayDate'  $cpeventtype    ORDER BY event_registration_id desc";
					}
		...
		<table class="table table-bordered table-sm" style="color:black;" border="1" id="example" width="100%" cellspacing="0">
			...
			?>
				<tr>
				    ...
				    <td style='white-space: nowrap;'>
					<a href="bookingcancelled.php?trans_id=<?php echo $row["Transaction_id"];?>" target = "blank" class="btn btn-primary" role="button">Cancelled</a>
				    </td>
