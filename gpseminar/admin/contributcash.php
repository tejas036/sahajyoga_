...
<div class="col-md-12" style="padding-bottom: 10px;">
                ...
                <a href="contributcash.php" class="btn-sm btn btn-success">Offline Cash Payment MIS Report</a>
		...
		<table class="table table-bordered table-sm" style="color:black;" border="1" id="example" width="100%" cellspacing="0">
			...
			?>
				<tr>
				    ...
				    <td style='white-space: nowrap;'>
					<a href="bookingcancelled3.php?trans_id=<?php echo $row["Transaction_id"];?>" target = "blank" class="btn btn-primary" role="button">Cancelled</a>
				    </td>
					<?php
					}
					else
		...
		<table class='table table-bordered hide' id="ex" width="100%" cellspacing="0">
         ...
         <tr>
		  ...
		  <td>
            ...
            {
           echo $adultcount= 5500;
            }
            else
            {
           echo $adultcount= 1300;
            }
		  ...
		  <?php 
				if($towards == 'International Sahaja Yoga Seminar Nirmal Nagari, Ganapatipule')
                {
               echo $adultcount=$row["count_adult"] * 5500;
                }
                else
                {
               echo $adultcount=$row["count_adult"] * 1300;
                }
		  ...
		  <?php 
			if($towards == 'International Sahaja Yoga Seminar Nirmal Nagari, Ganapatipule')
            {
           echo $adultcount=$row["count_yuva"] * 4500;
            }
            else
            {
           echo $adultcount=$row["count_yuva"] * 1300;
            }
		  ...
		  <?php 
				if($towards == 'International Sahaja Yoga Seminar Nirmal Nagari, Ganapatipule')
                {
               echo $adultcount=$row["count_child"] * 3000;
                }
                else
                {
               echo $adultcount=$row["count_child"] * 1300;	
                }
			...
			<tr>
				...
				<?PHP 
				  ...
				  $TTFemaleresult1 = $conn->query($TTFemale1)->fetch_assoc();
					...
					$adulttotal1 = $TTFemaleresult1['sum(count_adult)'] * 5500;
					...
					$adulttotal2 = $TTFemaleresult2['sum(count_adult)'] * 1300;	
					 
				
				
				echo $adulttotal1 + $adulttotal2;
				?>
				</td>
				...
				<?PHP 
						...
						$yuvatotal1 = $TTFemaleresult1['sum(count_yuva)'] * 4500;
				    ...
				    $yuvatotal2 = $TTFemaleresult2['sum(count_yuva)'] * 1300;	
					 
			 
				
				echo $yuvatotal1 + $yuvatotal2 ;
				?>
				</td>
				...
				$TTFemaleresult = $conn->query($TTFemale)->fetch_assoc();			
						...
						$childtotal1 = $TTFemaleresult1['sum(count_child)'] * 3000;
				
				
						$TTFemale2 = 'SELECT sum(count_child) from event_registration '. $queryCondition .' and Towards="Only day Puja, Ganapatipule"';
						$TTFemaleresult2 = $conn->query($TTFemale2)->fetch_assoc();

						$childtotal2 = $TTFemaleresult2['sum(count_child)'] * 1300;	
					
			 
				
				echo $childtotal1 + $childtotal2 ;
				?>
				</td>
