...
?>
          ...
          <div class="row">
            ...
            <div class="col-md-12" style="padding-bottom: 10px;">
                <a href="adminonline.php" class="btn-sm btn btn-success">Online Dashboard </a>
                ...
                <a href="adminforeign.php" class="btn-sm btn btn-info">Foreign Digital Dashboard</a>
          ...
          <?php
          $Date =  date("Y-m-d");
          $sql = "SELECT count(*) as totalTransanction, sum(Amount) as totalAmount FROM event_registration where status = 'Success' and paymenttype is NULL ";
          ...
          where ereg.status = 'success' and ereg.paymenttype is NULL";
          ...
          join event_registration ereg
          on part.event_registration_id= ereg.event_registration_id
          where ereg.status = 'success' and part.gender='Male' and ereg.paymenttype is NULL";
          ...
          join event_registration ereg
          on part.event_registration_id= ereg.event_registration_id
          where ereg.status = 'success' and part.gender='Female' and ereg.paymenttype is NULL";
    ...
    join event_registration ereg
    on part.event_registration_id= ereg.event_registration_id
    where part.participant_type='Adult' and ereg.status = 'success' and ereg.paymenttype is NULL";
    ...
    join event_registration ereg
    on part.event_registration_id= ereg.event_registration_id
    where part.participant_type='Adult' and ereg.status = 'success' and part.gender='Male' and ereg.paymenttype is NULL";
    ...
    join event_registration ereg
    on part.event_registration_id= ereg.event_registration_id
    where part.participant_type='Adult' and ereg.status = 'success' and part.gender='Female' and ereg.paymenttype is NULL";
    ...
    join event_registration ereg
    on part.event_registration_id= ereg.event_registration_id
    where part.participant_type='Yuva' and ereg.status = 'success' and ereg.paymenttype is NULL";
    ...
    join event_registration ereg
    on part.event_registration_id= ereg.event_registration_id
    where part.participant_type='Yuva' and ereg.status = 'success' and part.gender='Male' and ereg.paymenttype is NULL";
    ...
    join event_registration ereg
    on part.event_registration_id= ereg.event_registration_id
    where part.participant_type='Yuva' and ereg.status = 'success' and part.gender='Female' and ereg.paymenttype is NULL";
    ...
    join event_registration ereg
    on part.event_registration_id= ereg.event_registration_id
    where part.participant_type='Child' and ereg.status = 'success' and ereg.paymenttype is NULL";
    ...
    join event_registration ereg
    on part.event_registration_id= ereg.event_registration_id
    where part.participant_type='Child' and ereg.status = 'success' and part.gender='Male' and ereg.paymenttype is NULL";
    ...
    join event_registration ereg
    on part.event_registration_id= ereg.event_registration_id
    where part.participant_type='Child' and ereg.status = 'success' and part.gender='Female' and ereg.paymenttype is NULL";
    ...
    $Date =  date("Y-m-d");
		$sql = "SELECT count(*) as totalTransanction, sum(Amount) as totalAmount FROM event_registration where Transaction_start_time='" . $Date. "' and status = 'Success' and paymenttype is NULL";
    ...
    join event_registration ereg
    on part.event_registration_id= ereg.event_registration_id
    where part.participant_type='Adult' and ereg.status = 'success' and ereg.Transaction_start_time='$Date' and ereg.paymenttype is NULL";
    ...
    join event_registration ereg
    on part.event_registration_id= ereg.event_registration_id
    where part.participant_type='Adult' and ereg.status = 'success' and ereg.Transaction_start_time='$Date' and part.gender='Male' and ereg.paymenttype is NULL";
    ...
    join event_registration ereg
    on part.event_registration_id= ereg.event_registration_id
    where part.participant_type='Adult' and ereg.status = 'success' and ereg.Transaction_start_time='$Date' and part.gender='Female' and ereg.paymenttype is NULL";
    ...
    join event_registration ereg
    on part.event_registration_id= ereg.event_registration_id
    where part.participant_type='Yuva' and ereg.status = 'success' and ereg.Transaction_start_time='$Date' and ereg.paymenttype is NULL";
    ...
    join event_registration ereg
    on part.event_registration_id= ereg.event_registration_id
    where part.participant_type='Yuva' and ereg.status = 'success' and ereg.Transaction_start_time='$Date' and part.gender='Male' and ereg.paymenttype is NULL";
    ...
    join event_registration ereg
    on part.event_registration_id= ereg.event_registration_id
    where part.participant_type='Yuva' and ereg.status = 'success' and ereg.Transaction_start_time='$Date' and part.gender='Female' and ereg.paymenttype is NULL";
    ...
    join event_registration ereg
    on part.event_registration_id= ereg.event_registration_id
    where part.participant_type='Child' and ereg.status = 'success' and ereg.Transaction_start_time='$Date' and ereg.paymenttype is NULL";
    ...
    join event_registration ereg
    on part.event_registration_id= ereg.event_registration_id
    where part.participant_type='Child' and ereg.status = 'success' and ereg.Transaction_start_time='$Date' and part.gender='Male' and ereg.paymenttype is NULL";
    ...
    join event_registration ereg
    on part.event_registration_id= ereg.event_registration_id
    where part.participant_type='Child' and ereg.status = 'success' and ereg.Transaction_start_time='$Date' and part.gender='Female' and ereg.paymenttype is NULL";
