...
<head>
    ...
    <title>International Sahaja Yoga Seminar Nirmala Nagari, Ganapatipule, 2023</title>
...
<body onkeypress="return disableCtrlKeyCombination(event);" onkeydown="return disableCtrlKeyCombination(event);">
    ...
    <div class="container">
        ...
        <div class="main-content mt-5">
            ...
            <form class="form-basic" method="post" name="myForm" action="EazyPayPGeventforeign.php" id="formfield"
                enctype="multipart/form-data" style="max-width: 1040px; border-radius: 20px 20px 20px 20px; box-shadow: 0 -4px 6px 4px rgba(0, 0, 0, 0.1); margin: auto;">
                ...
                <div class="form-row">
                    <label>
                        ...
                        <select name="city" id="city" style="width:300px; max-width:100% !important;">
                ...
                <div class="form-row">
                    <label>
                        ...
                        <input type="text" name="dist" onkeydown="return /^[A-Za-z]*$/i.test(event.key)" id="dist">
                            ...
                            <div>
                                <label>
                                    <input class="common" type="radio" name="contriRadio" id="rad1"
                                        value='Foreign Sahaja Yogis paying via Indian Bank account' onclick="reset1()" checked />
                                    <span class="myradio">Foreign Sahaja Yogis paying via Indian Bank account</span>
                                </label>
                            </div>
                    ...
                    <table class="table table-bordered mytable" id="adult">
                        <thead>
                            <tr>
                                ...
                                <th scope="col" class="lebelCls">Country *</th>
                                <th scope="col" class="lebelCls">City *</th>
                    ...
                    <label>
                        ...
                        <script>
                            ...
                            function getAdultNumber(num) {
                                ...
                                finalTotalAmountAdult = 9000 * num;
                                finalTotalAdult = num;
                            ...
                            function getChildNumber(num) {
                                ...
                                let x = new Date().toISOString().slice(0, 10);
                                let y = new Date('2025-12-15').toISOString().slice(0, 10);
                                ...
                                finalTotalAmountChild = 7000 * num;
                                finalTotalChild = num;
                ...
                <div align="centre">
                    ...
                    <label>
                        ...
                        <input type="button" name="btn" value=" Proceed To Payment" class="btn btn-success mt-3" id="submitBtn" data-toggle="modal"
...
<script type="text/javascript">
    ...
    //             cell.id = 'adult2';
    //             var copycel =
    //                 '<input style="width:170px !important" class="eventtable" onkeydown="return /^[A-Za-z]*$/i.test(event.key)" type="text" id="adult_city" maxlength="20" name="adult_city[]" value="">';
    //             cell.innerHTML = copycel;
    ...
    function addRowsadult() {
        ...
        for (var i = 0; i < cellCount; i++) {
            ...
            `;
                ...
                cell = row.insertCell(3);
                cell.id = 'adult3';
                // Change input to a select for adult city
                cell.innerHTML = `
                <select style="width:130px !important" class="eventtable" id="adult_city_1" name="adult_city[]">
            ...
            `;
                ...
                cell.id = 'adult4';
                cell.innerHTML = `
                <input style="width:150px !important" class="eventtable" onkeydown="return /^[A-Za-z]*$/i.test(event.key)" type="text" id="adult_centre" maxlength="20" name="adult_centre[]" value="">
            `;

                cell = row.insertCell(5);
                cell.id = 'adult5';
                cell.innerHTML = `
               <input style="width:150px !important" class="eventtable" type="text" name="adult_badge_No[]" id="adult_badge_No" value="">
            `;

                getCountryadult(1); // Pass the row number to populate dropdown for the first row
                ...
                `;
                    ...
                    // Change input to a select for adult city
                    cell.innerHTML = `
                    <select style="width:130px !important" class="eventtable" id="adult_city_${rowCount}" name="adult_city[]">
                        <option value="">Select Country</option>
                    </select>
                `;
                    getCountryadult(rowCount); // Pass the row number to populate the dropdown
                } else if (i === 4) {
                    cell.innerHTML = `
                   <input style="width:150px !important" class="eventtable" onkeydown="return /^[A-Za-z]*$/i.test(event.key)" type="text" id="adult_centre_${rowCount}" maxlength="20" name="adult_centre[]" value="">
                `;
                } else if (i === 5) {
                    cell.innerHTML = `
                    <input style="width:150px !important" class="eventtable" type="text" name="adult_badge_No[]" id="adult_badge_No_${rowCount}" value="">
                `;
                }
            }
        }
    ...
    //             cell.id = 'yuva2';
    //             var copycel =
    //                 '<input style="width:170px !important" class="eventtable" onkeydown="return /^[A-Za-z]*$/i.test(event.key)" type="text" id="yuva_city" maxlength="20" name="yuva_city[]" value="">';
    //             cell.innerHTML = copycel;
    //             cell = row.insertCell(3);
    //             cell.id = 'yuva3';
    //             var copycel =
    ...
    function addRowsyuva() {
        ...
        for (var i = 0; i < cellCount; i++) {
            ...
            `;
                ...
                cell.id = 'yuva3';
                cell.innerHTML = `
                    <select style="width:130px !important" class="eventtable" id="yuva_city_${rowCount}" name="yuva_city[]">
                        <option value="">Select Country</option>
                    </select>
                `;
                ...
                cell.id = 'yuva4';
                cell.innerHTML = `
                <input style="width:150px !important" class="eventtable" onkeydown="return /^[A-Za-z]*$/i.test(event.key)" type="text" id="yuva_centre" maxlength="20" name="yuva_centre[]" value="">
            `;
                cell = row.insertCell(5);
                cell.id = 'yuva5';
                cell.innerHTML = `
                <input style="width:150px !important; class="eventtable" type="text" name="yuva_badge_No[]"  id="yuva_badge_No"  value="">
            `;
            ...
            `;
                    ...
                    getCountryuva(rowCount);

                } else if (i === 4) {
                    cell.innerHTML = `
                   <input style="width:150px !important" class="eventtable" onkeydown="return /^[A-Za-z]*$/i.test(event.key)" type="text" id="yuva_centre_${rowCount}" maxlength="20" name="yuva_centre[]" value="">
                `;
                } else if (i === 5) {
                    cell.innerHTML = `
                    <input style="width:150px !important; class="eventtable" type="text" name="yuva_badge_No[]"  id="yuva_badge_No_${rowCount}"  
                    value="">
                `;
                }
            }
    ...
    //             cell.id = 'child2';
    //             var copycel =
    //                 '<input style="width:170px !important" class="eventtable" onkeydown="return /^[A-Za-z]*$/i.test(event.key)" type="text" id="child_city" maxlength="20" name="child_city[]" value="">';
    //             cell.innerHTML = copycel;
    //             cell = row.insertCell(3);
    //             cell.id = 'child3';
    //             var copycel =
    ...
    function addRowschild() {
        ...
        for (var i = 0; i < cellCount; i++) {
            ...
            `;
                ...
                cell.id = 'child3';
                cell.innerHTML = `
                    <select style="width:130px !important" class="eventtable" id="child_city_${rowCount}" name="child_city[]">
                        <option value="">Select Country</option>
                    </select>
                `;
                ...
                cell.id = 'child4';
                cell.innerHTML = `
                <input style="width:150px !important" class="eventtable" onkeydown="return /^[A-Za-z]*$/i.test(event.key)" type="text" id="child_centre_${rowCount}" maxlength="20" name="child_centre[]" value="">
            `;
                cell = row.insertCell(5);
                cell.id = 'child5';
                cell.innerHTML = `
                <input style="width:150px !important; class="eventtable" type="text" name="child_badge_No[]"  id="child_badge_No"  value="">
            `;
    ...
    function checkAdult() {
        ...
        for (index = 0; index < document.getElementById("number_adult1").value; index++) {
            ...
            if (adultCity[index].value == "") {
                alert("Please select adult's country");
                //errorFlag=true;
    ...
    function checkYuva() {
        ...
        for (index = 0; index < document.getElementById('number_yuva1').value; index++) {
            ...
            if (yuvaCity[index].value == '') {
                alert("Please select yuva's country");
                //errorFlag=true;
    ...
    function checkChild() {
        ...
        for (index = 0; index < document.getElementById('number_child1').value; index++) {
            ...
            if (childCity[index].value == '') {
                alert("Please select child's country");
                //errorFlag=true;
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.status == 'success') {
                        ...
                        $('#city').val(response.data.country);
...
<script>
    function getCountryadult(rowIndex) {
        $.ajax({
            type: "POST",
            url: "datahandler1.php",
            data: {
                get_country_name: true
            },
            success: function(data) {
                // Target the specific district dropdown for the row
                $(`#adult_city_${rowIndex}`).html(data);
            }
        });
    }

    function getCountryuva(rowIndex) {
        $.ajax({
            type: "POST",
            url: "datahandler1.php",
            data: {
            ...
            success: function(data) {
                // Target the specific district dropdown for the row
                $(`#yuva_city_${rowIndex}`).html(data);
            }
        });
    }

    function getCountrychild(rowIndex) {
        $.ajax({
            type: "POST",
            url: "datahandler1.php",
            data: {
            ...
            success: function(data) {
                // Target the specific district dropdown for the row
                $(`#child_city_${rowIndex}`).html(data);
            }
        });
    }
</script>
