...
<body>
    ...
    <div class="card" style=" background-color: #FFFAFA;">
        <div class="card-body">
            ...
            <h6 style="text-align: center;"> December 22-25, 2024</h6>
            ...
            <ul>
                <li style="font-weight: 500;">Indian Sahaja yogis - Contribution for SEMINAR:
                    <div class="table-responsive">
                        <table class="tg">
                            ...
                            <tr>
                                <td class="tg-uzvj"></td>
                                <td class="tg-uzvj">   <br><span style="color:#002060">Upto December 15</span></td>
                                <td class="tg-uzvj">   <br><span style="color:#002060">From December 16 /</span><br>   <br><span style="color:#002060">At Puja Site</span>   </td>
                            ...
                            <tr>
                                ...
                                <td class="tg-9wq8"><span style="color:#002060">3600/-</span></td>
                                <td class="tg-9wq8"><span style="color:#002060">4500/-</span></td>
                                <td class="tg-9wq8"><span style="color:#002060">5500/-</span></td>
                            </tr>
                            <tr>
                                <td class="tg-5cz4"><span style="color:#002060">Yuvas</span></td>
                                <td class="tg-5cz4"><span style="color:#002060">2700/-</span></td>
                                <td class="tg-5cz4"><span style="color:#002060">3500/-</span></td>
                            ...
                            <tr>
                                ...
                                <td class="tg-9wq8"><span style="color:#002060">1800/-</span></td>
                        ...
                        <table class="tg">
                            <tbody>
                                <tr>
                                    ...
                                    <td class="tg-9wq8"><span style="color:#002060">ONLINE - 900/-</span></th>
                                    <td class="tg-9wq8"><span style="color:#002060">Cash - 1200/-</span></th>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                ...
                <li style="font-weight: 500;">Seminar Event expenses includes charges for Stay & Meals (i.e. breakfast, lunch, dinner) from December 22 to 25, 2024.
                </li>
...
<!--                </li>-->
                ...
                <li style="font-weight: 500;"><b>Only Puja Day Badges</b> covers only Puja and Mahaprasad. Badges will be given at the seminar site on or after December 25, 2024.
                </li>
            ...
            <center>
               ...
               <button class="btn btn-primary" onclick="myFun2()">Foreigner(NON-SARC) Digital & Cash Event Booking</button>
             
               <button class="btn btn-primary" style="margin: 20px;" onclick="myFun4()">Foreigner(SARC) Digital & Cash Event Booking</button>
                <?php
                    }
                    if($row['foodstay'] == 'yes')
                    {
    ...
    <script>
        ...
        function myFun4() {
            //location="https://www.sahajayogabharat.org/gpseminar/eventform.php";
            location="eventfromforeignsaarc.php";
        }
