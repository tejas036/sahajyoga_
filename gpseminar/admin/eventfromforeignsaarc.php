...
<head>
    ...
    <title>International Sahaja Yoga Seminar Nirmalaa Nagari, Ganapatipule, 2023</title>
...
<body onkeypress="return disableCtrlKeyCombination(event);" onkeydown="return disableCtrlKeyCombination(event);">
    <div class="container">
        ...
        <div class="main-content mt-5">
            ...
            <form class="form-basic" method="post" name="myForm" action="EazyPayPGeventforeignsaarc.php" id="formfield"
        ...
        for (var i = 0; i < cellCount; i++) {
            ...
            `;
                ...
                `;
                    ...
                    cell.innerHTML = `
                    <input style="width:150px !important; class="eventtable" type="text" name="adult_badge_No[]"  id="adult_badge_No_${rowCount}"  
                    value="">
                `;
                }
            }
