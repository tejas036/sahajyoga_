...
<body onkeypress="return disableCtrlKeyCombination(event);" onkeydown="return disableCtrlKeyCombination(event);">
    ...
    <!-- style="border-radius: 20px 20px 20px 20px;  box-shadow: 0 -4px 6px 4px rgba(0, 0, 0, 0.1);" -->
    <div class="main-content mt-5 mx-3">


        <form class="form-basic" method="post" name="myForm" action="EazyPayPGeventcash.php" id="formfield"
                    ...
                    <script>
                        ...
                        function getAdultNumber(num) {
                            ...
                            if (radioValue == 'International Sahaja Yoga Seminar Nirmal Nagari, Ganapatipule') {
                                finalTotalAmountAdult = 5500 * num;
                                finalTotalAdult = num;
                            } else {
                                finalTotalAmountAdult = 1200 * num;
                                finalTotalAdult = num;
                            }
                        ...
                        function getYuvaNumber(num) {
                            ...
                            if (radioValue == 'International Sahaja Yoga Seminar Nirmal Nagari, Ganapatipule') {
                                finalTotalAmountYuva = 4500 * num;
                                finalTotalYuva = num;
                            } else {
                                finalTotalAmountYuva = 1200 * num;
                                finalTotalYuva = num;
                            }
                        ...
                        function getChildNumber(num) {
                            ...
                            if (radioValue == 'International Sahaja Yoga Seminar Nirmal Nagari, Ganapatipule') {
                                finalTotalAmountChild = 3000 * num;
                                finalTotalChild = num;
                            } else {
                                finalTotalAmountChild = 1200 * num;
                                finalTotalChild = num;
                            }
            ...
            <div align="centre">
                ...
                <label>
                    ...
                    <input type="button" name="btn" class="btn btn-success mt-3" value=" Proceed To Payment" id="submitBtn" data-toggle="modal"
...
<script type="text/javascript">
    ...
    //             cell.id = 'adult0';
    //             cell.innerHTML = `
    //             <input style="width:180px !important" class="eventtable" type="text" onkeydown="return /^([^0-9]*)$/i.test(event.key)" id="adult_name_1" name="adult_name[]" value="">
    //         `;
    ...
    //             cell.id = 'adult2';
    //             cell.innerHTML = `
    //             <select style="width:200px !important" class="eventtable ustate" id="adult_city_1" name="adult_city[]" onChange="getdistrictadult(this.value, 1);">
    ...
    //             cell.id = 'adult3';
    //             cell.innerHTML = `
    //             <select style="width:200px !important" class="eventtable uadist" id="adult_centre_1" name="adult_centre[]">
    ...
    //             if (i === 0) {
    //                 cell.innerHTML = `
    //                 <input style="width:180px !important" class="eventtable" type="text" onkeydown="return /^([^0-9]*)$/i.test(event.key)" id="adult_name_${rowCount}" name="adult_name[]" value="">
    //             `;
    //             } else if (i === 1) {
    //                 cell.innerHTML = `
    ...
    //             } else if (i === 2) {
    //                 cell.innerHTML = `
    //                 <select style="width:200px !important" class="eventtable ustate" id="adult_city_${rowCount}" name="adult_city[]" onChange="getdistrictadult(this.value, ${rowCount});">
    //                     <option value="">Select State</option>
    //                 </select>
    //             `;
    //             } else if (i === 3) {
    //                 cell.innerHTML = `
    //                 <select style="width:200px !important" class="eventtable uadist" id="adult_centre_${rowCount}" name="adult_centre[]">
    //                     <option value="">Select District</option>
    //                 </select>
    //             `;
    //             } else if (i === 4) {
    //                 cell.innerHTML = `
    //                 <input style="width:210px !important; class="eventtable" type="text" name="adult_badge_No[]"  id="adult_badge_No_${rowCount}"  
    //                 value="">
    //             `;
    //             }
    //         }
    ...
    //             cell.id = 'yuva0';
    //             cell.innerHTML = `
    //             <input style="width:180px !important" class="eventtable" type="text" onkeydown="return /^([^0-9]*)$/i.test(event.key)" id="yuva_name_1" name="yuva_name[]" value="">
    //         `;
    ...
    //             cell.id = 'yuva2';
    //             cell.innerHTML = `
    //             <select style="width:200px !important" class="eventtable ustate1" id="yuva_city_1" name="yuva_city[]" onChange="getdistrictyuva(this.value, 1);">
    //                 <option value="">Select State</option>
    //             </select>
    //         `;
    ...
    //             cell.id = 'yuva3';
    //             cell.innerHTML = `
    //             <select style="width:200px !important" class="eventtable uadist1" id="yuva_centre_1" name="yuva_centre[]">
    //                 <option value="">Select District</option>
    //             </select>
    //         `;
    //             cell = row.insertCell(4);
    ...
    //             if (i === 0) {
    //                 cell.innerHTML = `
    //                 <input style="width:180px !important" class="eventtable" type="text" onkeydown="return /^([^0-9]*)$/i.test(event.key)" id="yuva_name_${rowCount}" name="yuva_name[]" value="">
    //             `;
    //             } else if (i === 1) {
    //                 cell.innerHTML = `
    ...
    //             } else if (i === 2) {
    //                 cell.innerHTML = `
    //                 <select style="width:200px !important" class="eventtable ustate1" id="yuva_city_${rowCount}" name="yuva_city[]" onChange="getdistrictyuva(this.value, ${rowCount});">
    //                     <option value="">Select State</option>
    //                 </select>
    //             `;
    //             } else if (i === 3) {
    //                 cell.innerHTML = `
    //                 <select style="width:200px !important" class="eventtable uadist1" id="yuva_centre_${rowCount}" name="yuva_centre[]">
    //                     <option value="">Select District</option>
    //                 </select>
    //             `;
    //             } else if (i === 4) {
    //                 cell.innerHTML = `
    //                 <input style="width:210px !important; class="eventtable" type="text" name="yuva_badge_No[]"  id="yuva_badge_No_${rowCount}"  
    //                 value="">
    //             `;
    //             }
    //         }
    ...
    //             cell.id = 'child2';
    //             cell.innerHTML = `
    //             <select style="width:200px !important" class="eventtable ustate2" id="child_city" name="child_city[]" onChange="getdistrictchild(this.value, 1);">
    //                 <option value="">Select State</option>
    //             </select>
    //         `;
    ...
    //             cell.id = 'child3';
    //             cell.innerHTML = `
    //             <select style="width:200px !important" class="eventtable uadist2" id="child_centre_1" name="child_centre[]">
    //                 <option value="">Select District</option>
    //             </select>
    //         `;
    //             cell = row.insertCell(4);
    ...
    //             if (i === 0) {
    //                 cell.innerHTML = `
    //                 <input style="width:180px !important" class="eventtable" onkeydown="return /^([^0-9]*)$/i.test(event.key)" type="text" id="child_name_${rowCount}" name="child_name[]" value="">
    //             `;
    //             } else if (i === 1) {
    //                 cell.innerHTML = `
    ...
    //             } else if (i === 2) {
    //                 cell.innerHTML = `
    //                 <select style="width:200px !important" class="eventtable ustate2" id="child_city_${rowCount}" name="child_city[]" onChange="getdistrictchild(this.value, ${rowCount});">
    //                     <option value="">Select State</option>
    //                 </select>
    //             `;
    //             } else if (i === 3) {
    //                 cell.innerHTML = `
    //                 <select style="width:200px !important" class="eventtable uadist2" id="child_centre_${rowCount}" name="child_centre[]">
    //                     <option value="">Select District</option>
    //                 </select>
    //             `;
    //             } else if (i === 4) {
    //                 cell.innerHTML = `
    //                 <input style="width:210px !important; class="eventtable" type="text" name="child_badge_No[]"  id="child_badge_No_${rowCount}"
    //                   value="">
    //             `;
    //             }
    //         }
