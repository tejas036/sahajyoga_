...
{
  $adulttotal=$adultcount * 9000;
  $yuvatotal=$yuvacount * 7000;
  $childtotal= $childcount * 7000;
...
if(isset($_POST['adult_name']) && isset($_POST['adult_gender']) && isset($_POST['adult_city']) && isset($_POST['adult_centre']) && isset($_POST['adult_age']))
{ 
...
$participent_type_child = "Child";
 ...
 include_once "../dbConnection.php";
    ...
    $sql = "INSERT INTO `event_registration` (`event_id`,`Fname`, `Lname`, `Mobile`, `Email`, `Country`, `PAN`, `Aadhar`, `Pin`, `Who_im`, `Transaction_id`, `Amount`, `Status`, `Transaction_start_time`, `Towards`,`receiptNumber`,`count_adult`,`count_yuva`,`count_child`,`dist`,`Payment_mode`,`Transaction_Number`,`paymenttype`,`userid`,`terms_conditions`)
