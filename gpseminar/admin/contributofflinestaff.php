	  ...
	  <div class="card-header py-3">
		...
		<!-- <input type="button" onclick="tableToExcel('example', 'W3C Example Table')" class="float-right" value="Export to Excel"> -->
				...
				<?php
				   ...
				   $sql11 = "SELECT * from tbl_admin_login where UserName='$usermail'";
				   ...
				   $yesterdayDate = "2023-10-20";
					...
					if(!empty($_POST["search"])) {
						...
						if (!empty($mobile))
							 ...
							 if(!empty($regid))
    					     $andParts[] = "userid = $regid";

						   $queryCondition .= " WHERE ".implode(" AND " , $andParts)." and paymenttype is not NULL";
					 ...
					 $sql = "SELECT * from event_registration WHERE Status = 'Success' and paymenttype is not NULL and userid = '$regid' and Transaction_start_time between '$yesterdayDate' and '$todayDate'  $cpeventtype    ORDER BY event_registration_id desc";
					}
