...
<style>
  ...
  display: none;
            ...
            <div class="col-md-12" style="padding-bottom: 10px;">
                <a href="contribut.php" class="btn-sm btn btn-success">Online Payment MIS Report</a>
				...
				<a href="contributeforeign_saarc.php" class="btn-sm btn btn-info" style="margin: 10px;">Foreign Digital (SAARC) Payment MIS Report</a>
              </div>
              <br>
		...
		<table class="table table-bordered table-sm" style="color:black;" border="1" id="example" width="100%" cellspacing="0">
			...
			?>
				<tr>
					...
					<a href="printreceipt.php?trans_id=<?php echo $row["Transaction_id"];?>" target = "blank" class="btn btn-primary" role="button">Email & Print</a>
				    </td>
					<?php
					}
					else
		...
		<table class='table table-bordered hide' id="ex" width="100%" cellspacing="0">
         ...
         <tr>
		   ...
		   <?PHP 
			...
			$maleresulta = $conn->query($male)->fetch_assoc();			
		    echo $maleresulta['Count(*)'];              
            ?>
          </td>	
		  ...
		  <td>
		   <?PHP 
			...
			$Femaleresulta = $conn->query($Female)->fetch_assoc();			
		    echo $Femaleresulta['Count(*)'];              
            ?>
          </td>	

		  <td><?php echo $maleresulta['Count(*)']+$Femaleresulta['Count(*)']; ?></td>
		  <td>
			<?php 
			if('2024-12-15' > $row["Transaction_start_time"])
			{
				if($towards == 'International Sahaja Yoga Seminar Nirmal Nagari, Ganapatipule')
                 {
				echo $adultcount= 3600;
				 }
				 else
				 {
				echo $adultcount= 900;
			...
			else
			{
				if($towards == 'International Sahaja Yoga Seminar Nirmal Nagari, Ganapatipule')
                 {
				echo $adultcountad= 4500;
				 }
				else
				 {
				echo $adultcountad= 900;
				 }
			}
		  ...
		  <?php 
			if('2024-12-15' > $row["Transaction_start_time"])
			{
				if($towards == 'International Sahaja Yoga Seminar Nirmal Nagari, Ganapatipule')
                 {
				echo $adultcount=$row["count_adult"] * 3600;
				 }
				 else
				 {
				echo $adultcount=$row["count_adult"] * 900;
				 }
			}
			else
			{
				if($towards == 'International Sahaja Yoga Seminar Nirmal Nagari, Ganapatipule')
                 {
				echo $adultcountad=$row["count_adult"] * 4500;
				 }
				else
				 {
				echo $adultcountad=$row["count_adult"] * 900;
				 }
			}
		  ...
		  <td>
		   <?PHP 
			...
			$maleresulty = $conn->query($male)->fetch_assoc();			
		    echo $maleresulty['Count(*)'];              
            ?>
          </td>	
		  ...
		  <td>
		   <?PHP 
			...
			$Femaleresulty = $conn->query($Female)->fetch_assoc();			
		    echo $Femaleresulty['Count(*)'];              
            ?>
          </td>	

		  <td><?php echo $maleresulty['Count(*)']+$Femaleresulty['Count(*)']; ?></td>
		  <td>
			<?php 
			if('2024-12-15' > $row["Transaction_start_time"])
			{
		  ...
		  <?php 
			if('2024-12-15' > $row["Transaction_start_time"])
			{
				if($towards == 'International Sahaja Yoga Seminar Nirmal Nagari, Ganapatipule')
                 {
				echo $adultcount=$row["count_yuva"] * 2700;
				 }
				 else
				 {
				echo $adultcount=$row["count_yuva"] * 900;
				 }
			}
			else
			{
				if($towards == 'International Sahaja Yoga Seminar Nirmal Nagari, Ganapatipule')
                 {
				echo $adultcountad=$row["count_yuva"] * 3500;
				 }
				 else
				 {
				echo $adultcountad=$row["count_yuva"] * 900;
				 }
			}
		  ...
		  <td>
		   <?PHP 
			...
			$maleresultc = $conn->query($male)->fetch_assoc();			
		    echo $maleresultc['Count(*)'];              
            ?>
          </td>	
		  ...
		  <td>
		   <?PHP 
			...
			$Femaleresultc = $conn->query($Female)->fetch_assoc();			
		    echo $Femaleresultc['Count(*)'];              
            ?>
          </td>	

		  <td><?php echo $maleresultc['Count(*)']+$Femaleresultc['Count(*)']; ?></td>
		  <td>
			<?php 
			if('2024-12-15' > $row["Transaction_start_time"])
			{
		  ...
		  <?php 
			if('2024-12-15' > $row["Transaction_start_time"])
			{
				if($towards == 'International Sahaja Yoga Seminar Nirmal Nagari, Ganapatipule')
                 {
				echo $adultcount=$row["count_child"] * 1800;
				 }
				 else
				 {
				echo $adultcount=$row["count_child"] * 900;	
				 }
			}
			else
			{
				...
				echo $adultcountad=$row["count_child"] * 2500;
				 ...
				 {
				echo $adultcountad=$row["count_child"] * 900;	
				 }
			}
		  ...
		  <td><?php echo $maleresulta['Count(*)']+$Femaleresulta['Count(*)']+ $maleresulty['Count(*)']+$Femaleresulty['Count(*)']+ $maleresultc['Count(*)']+$Femaleresultc['Count(*)']; ?></td>
		  <td><?php echo $row["Amount"]; ?></td>
			...
			<tr>
				...
				$Tmaleresulta = $conn->query($Tmale)->fetch_assoc();			
				echo $Tmaleresulta['Count(*)'];              
				?>
				</td>
				...
				$TFemaleresulta = $conn->query($TFemale)->fetch_assoc();			
				echo $TFemaleresulta['Count(*)'];             
				?>
				</td>

				<td>
				<?PHP	
				echo $Tmaleresulta['Count(*)']+$TFemaleresulta['Count(*)'];             
				?>
				</td>
				...
				if('2024-12-15' > $row["Transaction_start_time"])
				{
				  ...
				  $TTFemale1 = 'SELECT sum(count_adult) from event_registration '. $queryCondition .' and Towards="International Sahaja Yoga Seminar Nirmal Nagari, Ganapatipule"';
				  $TTFemaleresult1 = $conn->query($TTFemale1)->fetch_assoc();

					$adulttotal1 = $TTFemaleresult1['sum(count_adult)'] * 3600;
				    
				    
					$TTFemale2 = 'SELECT sum(count_adult) from event_registration '. $queryCondition .' and Towards="Only day Puja, Ganapatipule"';
					$TTFemaleresult2 = $conn->query($TTFemale2)->fetch_assoc();

					$adulttotal2 = $TTFemaleresult2['sum(count_adult)'] * 900;	
					 
				}
				else
				{
					
				  $TTFemale3 = 'SELECT sum(count_adult) from event_registration '. $queryCondition .' and Towards="International Sahaja Yoga Seminar Nirmal Nagari, Ganapatipule"';
				  $TTFemaleresult3 = $conn->query($TTFemale3)->fetch_assoc();

				  $adulttotal3 =  $TTFemaleresult3['sum(count_adult)'] * 4500;
					
					
					
					$TTFemale4 = 'SELECT sum(count_adult) from event_registration '. $queryCondition .' and Towards="Only day Puja, Ganapatipule"';
					$TTFemaleresult4 = $conn->query($TTFemale4)->fetch_assoc();

					$adulttotal4 =  $TTFemaleresult4['sum(count_adult)'] * 900;
					 
				} 
				
				echo $adulttotal1 + $adulttotal2 + $adulttotal3 + $adulttotal4;
				?>
				</td>
				...
				$Tmaleresulty = $conn->query($Tmale)->fetch_assoc();			
				echo $Tmaleresulty['Count(*)'];              
				?>
				</td>
				...
				$TFemaleresulty = $conn->query($TFemale)->fetch_assoc();			
				echo $TFemaleresulty['Count(*)'];             
				?>
				</td>

				<td>
				<?PHP	
				echo $Tmaleresulty['Count(*)']+$TFemaleresulty['Count(*)'];             
				?>
				</td>
				...
				if('2024-12-15' > $row["Transaction_start_time"])
				{
						...
						$TTFemale1 = 'SELECT sum(count_yuva) from event_registration '. $queryCondition .' and Towards="International Sahaja Yoga Seminar Nirmal Nagari, Ganapatipule"';
						$TTFemaleresult1 = $conn->query($TTFemale1)->fetch_assoc();

						$yuvatotal1 = $TTFemaleresult1['sum(count_yuva)'] * 2700;
				
				
				
				
						$TTFemale2 = 'SELECT sum(count_yuva) from event_registration '. $queryCondition .' and Towards="Only day Puja, Ganapatipule"';
					$TTFemaleresult2 = $conn->query($TTFemale2)->fetch_assoc();

				    $yuvatotal2 = $TTFemaleresult2['sum(count_yuva)'] * 900;	
					 
				}
				else
				{
				
						$TTFemale3 = 'SELECT sum(count_yuva) from event_registration '. $queryCondition .' and Towards="International Sahaja Yoga Seminar Nirmal Nagari, Ganapatipule"';
						$TTFemaleresult3 = $conn->query($TTFemale3)->fetch_assoc();

						$yuvatotal3 = $TTFemaleresult3['sum(count_yuva)'] * 3500;
					
					
					
						$TTFemale4 = 'SELECT sum(count_yuva) from event_registration '. $queryCondition .' and Towards="Only day Puja, Ganapatipule"';
					$TTFemaleresult4 = $conn->query($TTFemale4)->fetch_assoc();

					$yuvatotal4 = $TTFemaleresult4['sum(count_yuva)'] * 900;	
				
				}  
				
				echo $yuvatotal1 + $yuvatotal2 + $yuvatotal3 + $yuvatotal4;
				?>
				</td>
				...
				$Tmaleresultc = $conn->query($Tmale)->fetch_assoc();			
				echo $Tmaleresultc['Count(*)'];              
				?>
				</td>
				...
				$TFemaleresultc = $conn->query($TFemale)->fetch_assoc();			
				echo $TFemaleresultc['Count(*)'];             
				?>
				</td>

				<td>
				<?PHP 	
				echo $Tmaleresultc['Count(*)']+$TFemaleresultc['Count(*)'];             
				?>
				</td>
				...
				if('2024-12-15' > $row["Transaction_start_time"])
				{
						...
						$TTFemale1 = 'SELECT sum(count_child) from event_registration '. $queryCondition .' and Towards="International Sahaja Yoga Seminar Nirmal Nagari, Ganapatipule"';
						$TTFemaleresult1 = $conn->query($TTFemale1)->fetch_assoc();

						$childtotal1 = $TTFemaleresult1['sum(count_child)'] * 1800;
				
				
						$TTFemale2 = 'SELECT sum(count_child) from event_registration '. $queryCondition .' and Towards="Only day Puja, Ganapatipule"';
						$TTFemaleresult2 = $conn->query($TTFemale2)->fetch_assoc();

						$childtotal2 = $TTFemaleresult2['sum(count_child)'] * 900;	
				...
				else
				{
						...
						$TTFemale3 = 'SELECT sum(count_child) from event_registration '. $queryCondition .' and Towards="International Sahaja Yoga Seminar Nirmal Nagari, Ganapatipule"';
						$TTFemaleresult3 = $conn->query($TTFemale3)->fetch_assoc();

						$childtotal3 = $TTFemaleresult3['sum(count_child)'] * 2500;
				
				
						$TTFemale4 = 'SELECT sum(count_child) from event_registration '. $queryCondition .' and Towards="Only day Puja, Ganapatipule"';
						$TTFemaleresult4 = $conn->query($TTFemale4)->fetch_assoc();

						$childtotal4 = $TTFemaleresult4['sum(count_child)'] * 900;	
						
					
				}   
				
				echo $childtotal1 + $childtotal2 + $childtotal3 + $childtotal4;
				?>
				</td>
			...
			<td>
				...
				<td>
				<?PHP	
				echo $Tmaleresult['Count(*)']+$TFemaleresult['Count(*)'];             
				?>
				</td>
