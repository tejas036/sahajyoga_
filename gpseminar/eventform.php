...
// Assuming $_SESSION['email'] holds the user ID (ensure this is correct)
...
$stmt->bind_param('s', $userId); // Change 'i' to 's' if userId is a string
$stmt->execute();
...
<head>
    ...
    <!-- Load Bootstrap JS (with Popper.js included) -->
    ...
    <style>
        ...
        /* Adjust margin and padding of the modal */
        .modal-dialog {
            margin: 30px auto;
        }
        ...
        /* Default styling for the 'payerdetailsreciept' button (initially hidden) */
        #payerdetailsreciept {
        ...
        /* Hover effect for 'payerdetailsreciept' button */
        #payerdetailsreciept:hover {
            background-color: #218838;
            /* Darker shade of green or any hover color */
        }
...
<body onkeypress="return disableCtrlKeyCombination(event);" onkeydown="return disableCtrlKeyCombination(event);   ">
    ...
    <!-- <div align="centre">
            ...
            <a href="../sahajoga_Profile/index.php" target="_blank">Participant Login</a>
    ...
    <div class="main-content " style="margin-top: 40px; ">
        ...
        <div class="container">
            <!-- id="formfield" -->
            <form class="form-basic " method="post" name="myForm" action="EazyPayPGevent.php" id="multiStepForm"


                enctype="multipart/form-data" style="border-radius: 20px 20px 20px 20px; box-shadow: 0 -4px 6px 4px rgba(0, 0, 0, 0.1) ">
                ...
                <div class="step active">
                    ...
                    <div class="form-row">
                        ...
                        <label>
                            ...
                            <input type="text" name="pan" id="pan" maxlength="10"
                                value="<?php echo isset($user['pan_number']) ? htmlspecialchars($user['pan_number']) : ''; ?>">
                    ...
                    <div class="form-row">
                        ...
                        <label>
                            ...
                            <input type="text" name="aadhaar" id="aadhaar"
                                value="<?php echo isset($user['aadhaar_number']) ? htmlspecialchars($user['aadhaar_number']) : ''; ?>">
                    ...
                    <div style="display: flex; justify-content: center;">
                        ...
                        <!-- <button type="button" onclick="nextStep()" class="btn btn-summary">Next</button> -->
                        <button type="button" id="payerdetails" class="btn btn-summary">Next</button>
                        <button type="button" id="payerdetailsreciept" data-toggle="modal" data-target="#payerdetailsmodal" class="btn btn-success" >Payerdetails</button>
                ...
                <div class="step">
                            ...
                            <table class="table table-bordered mytable" id="yuva">
                                ...
                                <thead>
                                    ...
                                    <tr>
                                        ...
                                        <th scope="col" class="lebelCls" style="width: 180px;">Yuva Name *</th>

                                        <th scope="col" class="lebelCls" style="width: 180px;">Gender *</th>

                                        <th scope="col" class="lebelCls" style="width: 120px;">Age *</th>

                                        <th scope="col" class="lebelCls" style="width: 170px;">State *</th>

                                        <th scope="col" class="lebelCls" style="width: 150px;">District *</th>
                            ...
                            <table class="table table-bordered mytable" id="child">
                                ...
                                <thead>
                                    ...
                                    <tr>
                                        ...
                                        <th scope="col" class="lebelCls" style="width: 180px;">Child Name *</th>
                    ...
                    <div class="pl-5" style="display: flex; justify-content: center; ">

                        <!-- <button type="button" onclick="prevStep()" class="btn btn-summary">Previous</button> -->
                ...
                <div align="centre" style="margin-top: 30px;">
                    ...
                    <label>
                        ...
                        <input type="button" name="btn" value=" Proceed To Payment" class="btn btn-success" id="submitBtn" data-toggle="modal"

                            data-target="#confirm-submit" style="display:none; color:#fff" />
                        <!-- -->
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <table class="table">
                        ...
                        <tbody id="adultInfoRows">
                            <!-- Adult info will be appended here -->
                        </tbody>
                        <tr>
                            <th>Total Yuva</th>
                            <td id="s_number_yuva"></td>
                        </tr>
                        <tbody id="yuvaInfoRows">
                            <!-- Yuva info will be appended here -->
                        </tbody>
                        <tr>
                            <th>Total Child</th>
                            <td id="s_number_child"></td>
                        </tr>
                        <tbody id="childInfoRows">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" id="submit" class="btn btn-success success">Submit</button>
    ...
    <script type="text/javascript">
        ...
        //                 '<select style="width:200px !important" class="eventtable ustate" id="adult_city" name="adult_city[]" value="" onChange="getdistrictadult(this.value);"> </select>';
        ...
        //                 '<select style="width:200px !important" class="eventtable uadist" id="adult_city" name="adult_centre[]" value=""> </select>';
        ...
        function addRowschild() {
            ...
            `;
                    ...
                    cell.id = 'child2';
                    cell.innerHTML = `
                <select style="width:130px !important" class="eventtable ustate2" id="child_city_1" name="child_city[]" onChange="getdistrictchild(this.value, 1);">
                    <option value="">Select State</option>
                </select>
            `;
            ...
            `;
                ...
                `;
                        ...
                        cell.innerHTML = `
                <input style="width:80px !important" class="eventtable"  type="text" id="child_age_${rowCount}" name="child_age[]" value="">
            
            `;
                    } else if (i === 3) {
                        cell.innerHTML = `
                    <select style="width:150px !important" class="eventtable ustate2" id="child_city_${rowCount}" name="child_city[]" onChange="getdistrictchild(this.value, ${rowCount});">
                        <option value="">Select State</option>
                    </select>
                `;
                    } else if (i === 4) {
        ...
        $('#submitBtn').click(function() {
            ...
            // Clear existing table rows for adult, yuva, and child info
            $('#adultInfoRows').empty();
            $('#yuvaInfoRows').empty();
            $('#childInfoRows').empty();

            // Get adult names and ages
            let adultNames = document.getElementsByName("adult_name[]");
            let adultAges = document.getElementsByName("adult_age[]");

            // Loop through adults and add rows
            for (let i = 0; i < adultNames.length; i++) {
                let name = adultNames[i].value || '';
                let age = adultAges[i].value || '';
                let row = `<tr><th>Adult ${i + 1}</th><td> <strong>Name:</strong> ${name},  <strong>Age</strong>: ${age}</td></tr>`;
                $('#adultInfoRows').append(row);
            }

            // Get yuva names and ages
            let yuvaNames = document.getElementsByName('yuva_name[]');
            let yuvaAges = document.getElementsByName('yuva_age[]');

            // Loop through yuvas and add rows
            for (let i = 0; i < yuvaNames.length; i++) {
                let name = yuvaNames[i].value || '';
                let age = yuvaAges[i].value || '';
                let row = `<tr><th>Yuva ${i + 1}</th><td><strong>Name:</strong> ${name},<strong> Age: </strong>${age}</td></tr>`;
                $('#yuvaInfoRows').append(row);
            }

            // Get child names and ages
            let childNames = document.getElementsByName('child_name[]');
            let childAges = document.getElementsByName('child_age[]');

            // Loop through children and add rows
            for (let i = 0; i < childNames.length; i++) {
                let name = childNames[i].value || '';
                let age = childAges[i].value || '';
                let row = `<tr><th>Child ${i + 1}</th><td><strong>Name:</strong> ${name}, <strong>Age:</strong> ${age}</td></tr>`;
                $('#childInfoRows').append(row);
            }
        ...
        $('#payerdetails').click(function() {
            // Set values from input fields
            $('#p_fname').text($('#fname').val());
            $('#p_lname').text($('#lname').val());
            $('#p_email').text($('#email').val());
            $('#p_mobile').text($('#mobile').val());
            $('#p_dist').text($('#dist').val());
            $('#p_pincode').text($('#pincode').val());
            $('#p_pan').text($('#pan').val());
            $('#p_aadhaar').text($('#aadhaar').val());
        });
        ...
        function payerdetailsvalidity() {
            // Check each validation condition and return immediately if any fail
            if (!checkFirstName()) {
            ...
            if (!checkdist()) {
                // console.log("Validation failed: District is required.");
                return false;
            }
            ...
            if (!checkPan()) {
                // console.log("Validation failed: PAN number is required.");
                return false;
            }

            if (!checkAadhaar()) {
                // console.log("Validation failed: AADHAAR number is required.");
                return false;
            }

            if (!checkList()) {
                // console.log("Validation failed: At least one item must be selected.");
                return false;
            }
        ...
        // Click handler to check validity and show/hide buttons
        $(document).ready(function() {
            $('#payerdetails').click(function() {
                if (payerdetailsvalidity()) {
                    console.log("Validation passed. Showing receipt and hiding button.");
                    $('#payerdetailsreciept').fadeIn();
                    $('#payerdetails').hide();
                } else {
                    console.log("Validation failed. Button visibility unchanged.");
                }
            });
        });
...
<div class="modal fade" id="payerdetailsmodal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" onclick="nextStep()" data-dismiss="modal" class="btn btn-primary">Next</button>
            </div>
        </div>
    </div>
</div>
