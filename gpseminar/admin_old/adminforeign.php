...
?>
          ...
          <?php
          $Date =  date("Y-m-d");
          $sql = "SELECT count(*) as totalTransanction, sum(Amount) as totalAmount FROM event_registration where status = 'Success' and paymenttype ='foreign' ";
          ...
          where ereg.status = 'success' and ereg.paymenttype ='foreign'";
          ...
          join event_registration ereg
          on part.event_registration_id= ereg.event_registration_id
          where ereg.status = 'success' and part.gender='Male' and ereg.paymenttype ='foreign'";
          ...
          join event_registration ereg
          on part.event_registration_id= ereg.event_registration_id
          where ereg.status = 'success' and part.gender='Female' and ereg.paymenttype ='foreign'";
    ...
    join event_registration ereg
    on part.event_registration_id= ereg.event_registration_id
    where part.participant_type='Adult' and ereg.status = 'success' and ereg.paymenttype ='foreign'";
    ...
    join event_registration ereg
    on part.event_registration_id= ereg.event_registration_id
    where part.participant_type='Adult' and ereg.status = 'success' and part.gender='Male' and ereg.paymenttype ='foreign'";
    ...
    join event_registration ereg
    on part.event_registration_id= ereg.event_registration_id
    where part.participant_type='Adult' and ereg.status = 'success' and part.gender='Female' and ereg.paymenttype ='foreign'";
    ...
    join event_registration ereg
    on part.event_registration_id= ereg.event_registration_id
    where part.participant_type='Yuva' and ereg.status = 'success' and ereg.paymenttype ='foreign'";
    ...
    join event_registration ereg
    on part.event_registration_id= ereg.event_registration_id
    where part.participant_type='Yuva' and ereg.status = 'success' and part.gender='Male' and ereg.paymenttype ='foreign'";
    ...
    join event_registration ereg
    on part.event_registration_id= ereg.event_registration_id
    where part.participant_type='Yuva' and ereg.status = 'success' and part.gender='Female' and ereg.paymenttype ='foreign'";
    ...
    join event_registration ereg
    on part.event_registration_id= ereg.event_registration_id
    where part.participant_type='Child' and ereg.status = 'success' and ereg.paymenttype ='foreign'";
    ...
    join event_registration ereg
    on part.event_registration_id= ereg.event_registration_id
    where part.participant_type='Child' and ereg.status = 'success' and part.gender='Male' and ereg.paymenttype ='foreign'";
    ...
    join event_registration ereg
    on part.event_registration_id= ereg.event_registration_id
    where part.participant_type='Child' and ereg.status = 'success' and part.gender='Female' and ereg.paymenttype ='foreign'";
    ...
    $Date =  date("Y-m-d");
		$sql = "SELECT count(*) as totalTransanction, sum(Amount) as totalAmount FROM event_registration where Transaction_start_time='" . $Date. "' and status = 'Success' and paymenttype ='foreign'";
    ...
    join event_registration ereg
    on part.event_registration_id= ereg.event_registration_id
    where part.participant_type='Adult' and ereg.status = 'success' and ereg.Transaction_start_time='$Date' and ereg.paymenttype ='foreign'";
    ...
    join event_registration ereg
    on part.event_registration_id= ereg.event_registration_id
    where part.participant_type='Adult' and ereg.status = 'success' and ereg.Transaction_start_time='$Date' and part.gender='Male' and ereg.paymenttype ='foreign'";
    ...
    join event_registration ereg
    on part.event_registration_id= ereg.event_registration_id
    where part.participant_type='Adult' and ereg.status = 'success' and ereg.Transaction_start_time='$Date' and part.gender='Female' and ereg.paymenttype ='foreign'";
    ...
    join event_registration ereg
    on part.event_registration_id= ereg.event_registration_id
    where part.participant_type='Yuva' and ereg.status = 'success' and ereg.Transaction_start_time='$Date' and ereg.paymenttype ='foreign'";
    ...
    join event_registration ereg
    on part.event_registration_id= ereg.event_registration_id
    where part.participant_type='Yuva' and ereg.status = 'success' and ereg.Transaction_start_time='$Date' and part.gender='Male' and ereg.paymenttype ='foreign'";
    ...
    join event_registration ereg
    on part.event_registration_id= ereg.event_registration_id
    where part.participant_type='Yuva' and ereg.status = 'success' and ereg.Transaction_start_time='$Date' and part.gender='Female' and ereg.paymenttype ='foreign'";
    ...
    join event_registration ereg
    on part.event_registration_id= ereg.event_registration_id
    where part.participant_type='Child' and ereg.status = 'success' and ereg.Transaction_start_time='$Date' and ereg.paymenttype ='foreign'";
    ...
    join event_registration ereg
    on part.event_registration_id= ereg.event_registration_id
    where part.participant_type='Child' and ereg.status = 'success' and ereg.Transaction_start_time='$Date' and part.gender='Male' and ereg.paymenttype ='foreign'";
    ...
    join event_registration ereg
    on part.event_registration_id= ereg.event_registration_id
    where part.participant_type='Child' and ereg.status = 'success' and ereg.Transaction_start_time='$Date' and part.gender='Female' and ereg.paymenttype ='foreign'";
