...
{
  $adulttotal=$adultcount * 5500;
  $yuvatotal=$yuvacount * 4500;
  $childtotal= $childcount * 3000;
  $gtotal=$adulttotal+$yuvatotal+$childtotal;
}
else
{
  $adulttotal=$adultcount * 1300;
  $yuvatotal=$yuvacount * 1300;
  $childtotal= $childcount * 1300;
  $gtotal=$adulttotal+$yuvatotal+$childtotal;
}
