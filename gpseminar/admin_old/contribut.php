	  ...
	  <div class="card-body">
		...
		<table class='table table-bordered hide' id="ex" width="100%" cellspacing="0">
         ...
         <tr>
		  ...
		  <td>
			<?php 
			if('2023-12-13' > $row["Transaction_start_time"])
			{
			...
			<tr>
				...
				if('2023-12-13' > $row["Transaction_start_time"])
				{
				  ...
				  $TTFemaleresult1 = $conn->query($TTFemale1)->fetch_assoc();
					...
					$adulttotal1 = $TTFemaleresult1['sum(count_adult)'] * 4000;
					...
					$adulttotal2 = $TTFemaleresult2['sum(count_adult)'] * 1000;	
				...
				else
				{
				  ...
				  $adulttotal3 =  $TTFemaleresult3['sum(count_adult)'] * 5000;
					...
					$adulttotal4 =  $TTFemaleresult4['sum(count_adult)'] * 1000;
				...
				if('2023-12-13' > $row["Transaction_start_time"])
				{
						...
						$yuvatotal1 = $TTFemaleresult1['sum(count_yuva)'] * 3000;
				    ...
				    $yuvatotal2 = $TTFemaleresult2['sum(count_yuva)'] * 1000;	
				...
				else
				{
						...
						$yuvatotal3 = $TTFemaleresult3['sum(count_yuva)'] * 4000;
					...
					$yuvatotal4 = $TTFemaleresult4['sum(count_yuva)'] * 1000;	
				...
				else
				{
						...
						$childtotal4 = $TTFemaleresult4['sum(count_child)'] * 1000;	
