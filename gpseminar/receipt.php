...
$ID =  $_GET['event_registration_id'] ;

include_once 'dbConnection.php';

	$sql = "SELECT * from event_registration WHERE  event_registration_id = '".$ID."'";
...
<!DOCTYPE html >
		...
		#t9_1{left:185px;bottom:533px;letter-spacing:0.17px; }
		#ta_1{left:650px;bottom:533px;letter-spacing:0.08px;word-spacing:0.04px;}
		#tb_1{left:725px;bottom:533px;letter-spacing:0.16px; }
		#tc_1{left:49px;bottom:493px;letter-spacing:0.13px;word-spacing:0.01px;}
		#td_1{left:362px;bottom:493px;letter-spacing:0.25px;word-spacing:-0.03px; }
		...
		#to_1{left:650px;bottom:333px;letter-spacing:0.08px;word-spacing:0.04px;}
		#tp_1{left:725px;bottom:333px;letter-spacing:0.16px; }
...
<?php }
	...
	?>
		...
		<div id="tam" class="t s4">OTHER CONTRIBUTION :      ______________________________________</div>
