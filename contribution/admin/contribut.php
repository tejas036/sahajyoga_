				...
				<div class="row">
					<div class="col-sm-6">
						<div class="form-group">
							...
							<?php if (is_null($product) || $product == "" ) { ?> <option value="" >Select</option> <?php }else{ ?>
							  ...
							  <option value="100th Birth Anniversary General Donation">100th Birth Anniversary General Donation</option>
					...
					<div class="col-sm-6">
						<div class="form-group">
							...
							<?php if (is_null($status)) { ?> <option value="" >Select</option> <?php }else{ ?>
