...
<body>
  <?php
   ...
   $sqlrahuri = "SELECT * FROM event_registration_rahuri where Transaction_id='" . $_POST['ReferenceNo'] . "'";
    ...
    if ($paymentType == "CONTRIBUTION") 
    {
      if ($_POST['Response_Code'] == 'E000') {
        ...
        if ($Who_im == 'Contribution') {
          ...
          $backToForm = "http://sahajayogamumbai.org/contribution/index.php";
        }
    ...
    else if ($paymentType == 'event_food') 
    {
      ...
      mail($to, $subject, $body, $headers);
        ...
        $backToEventFood = 'https://www.sahajayogamumbai.org/gpseminar/food_charges.php';
        $response = response_code($_POST['Response_Code']);
        //echo $response;
        echo "<div style='text-align:center; width: 100%;font-size:20px;'>
            <p>Sorry for the inconvenience caused.</p>";
    ...
    else if ($paymentType == 'EVENT_RAHURI') 
    {
      ...
      <a href="https://www.sahajayogamumbai.org/nirmaldhamaradgaon/index.php" class="btn btn-info"> go to home</a>
      </center>
      </div>
       ...
       <?php
        ...
        $subject = "[Failed Payment Receipt for] Maharashtra Yuva Shakti Seminar - 2023";
        //$message = "<p>Dear ".$firstName. " " .$lastName. ", Thank you very much for your contribution. Please find the receipt of your payment attached with this email. </p>";
        ...
        margin-left: 10px;
                font-size: 17px;">
                    <h6>
                    <b>Your payment for Maharashtra Yuva Shakti Seminar - 2023 Aradgaon (Rahuri)' . $payment_for . ' is UNSUCCESSFUL.  Please try again.</b>
                    </h6>
            ...
            Thanks & Regards,<br>
            Maharashtra Yuva Shakti Seminar, Aradgaon (Rahuri)<br>
    ...
    { 
      // for event registration purpose receipt
      if ($_POST['Response_Code'] == 'E000') 
      {
        // echo "<script>alert('" . $_POST['Response_Code'] ."')</script>";
        $_SESSION["ReferenceNo"] = $_POST['ReferenceNo'];
      ...
      else if($_POST['Response_Code'] == 'E00335') 
      {
        $back = 'https://www.sahajayogamumbai.org/gpseminar/event-form.php';
        ...
        echo"
          ...
          <div style='text-align:center; margin:80px 0px;'>
            ...
            <img src='cancel_cp.png' style='width:120px;'>
            <br> <br>
            <h2>Your Transaction Has Been cancelled.</h2>
            <br>
            <a href='https://www.sahajayogamumbai.org/gpseminar/index.php'>Back to Event Form</a>
            &nbsp;&nbsp;&nbsp;&nbsp;
            <a style='background:#5b3671;' href='https://www.sahajayogamumbai.org/'>Back to Home</a>
          </div>
        ";
      }
      else
      { 
        ...
        $body .='
          ...
          <html lang="en"><head>
            ...
            margin-left: 10px;
                    font-size: 17px;">
                        <h6>
                        <b>Your payment for International Sahaja Yoga Seminar - 2022, Ganpatipule ' . $payment_for . ' is UNSUCCESSFUL.  Please try again.</b>
                        </h6>
        ...
        echo"
          ...
          <div style='text-align:center; margin:80px 0px;'>
            ...
            <img src='cancel_cp.png' style='width:140px;'>
            <br> <br>
            <h1>Your Transaction Has Been Failed.</h1>
            <p>
              In case your account has been debited, We will send you a receipt and booking confirmation on email.<br>
              Please wait for 24 hours for us to reconcile your payment with the bank.<br>
              If you've any query, please reach out to us :
              <b>Mobile : 7972486996</b> &nbsp;&nbsp;&nbsp;  <b>Email : support@dexpertsystems.com</b>
            </p>
            <br>
            <a href='https://www.sahajayogamumbai.org/gpseminar/index.php'>Back to Event Form</a>
            &nbsp;&nbsp;&nbsp;&nbsp;
