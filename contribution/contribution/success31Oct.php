    ...
    Transaction_end_time = '" . $_POST['Transaction_Date'] . "'
      where Transaction_id='" . $_POST['ReferenceNo'] . "' ";
        ...
        if ($_POST['Response_Code'] == 'E000') {
            ...
            $back = 'https://www.sahajayogamumbai.org/gpseminar/eventform.php';
            ...
            echo "<p> If you have any queries regarding payments please write to seminar.payments@thelifeeternaltrustmumbai.org .</p>";
        }
    } ?>
</body>
