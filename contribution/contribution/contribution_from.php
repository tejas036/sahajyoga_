    ...
    <div class="main-content">
        ...
        <form class="form-basic" method="post" action="EazyPayPGtest.php" id="formfield" >
            ...
            <div class="form-row">
                <label>
                    <span>Mobile No. *</span>
                    <input type="text" name="mobile" id="mobile" value="<?php if($row2['Mobile'] !=''){echo $row2['Mobile'];}else{echo $mobile;} ?>"  />
                </label>
            </div>
            ...
            <div class="form-row">
                ...
                <div class="form-radio-buttons" id="paymentType">
                    ...
                    <div>
                        <label>
                            <input onclick="radioEevent(this.id)" type="radio" name="radio" id="general_donation" checked/>
                    ...
                    <div style="display:none">
                        <label>
                            <input onclick="radioEevent(this.id)" type="radio" name="radio" id="corpus_fund"/ disabled>
