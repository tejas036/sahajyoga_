...
margin-left: 10px;
            ...
            <div class="row" style="margin:40px 10px;">
                ...
                <div class="col-md-6">
                    ...
                    <div style="text-align: center; padding: 10px 0px;">
                        <a href="https://www.sahajayogabharat.org/sahajayoga_profile/" class="btn btn-sm btn-outline-dark">Go to My Profile</a>
                        &nbsp;&nbsp;&nbsp;
     ...
     else if ($paymentType == 'EVENT_RAHURI') 
    {
      ...
      <a href="https://www.sahajayogabharat.org/nirmaldhamaradgaon/index.php" class="btn btn-info"> go to home</a>
      </center>
      </div>
