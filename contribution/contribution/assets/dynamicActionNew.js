...
function radioEevent(myRadio){
		...
		var A = ["The Life Eternal Trust General Donation","Sahaja Yoga Centre Mumbai General Donation","International Sahaja Yoga Reasearch and Health Centre General Donation","Nirmal Nagari Ganapatipule General Donation","Vaitarna Academy General Donation","Kothrud Pune Ashram General Donation","Aradgaon Rahuri Ashram General Donation"];
		var B = ["The Life Eternal Trust Corpus Fund","Sahaja Yoga Centre Mumbai Corpus Fund","International Sahaja Yoga Reasearch and Health Centre Corpus Fund","Nirmal Nagari Ganapatipule Corpus Fund","Vaitarna Academy Corpus Fund","Kothrud Pune Ashram Corpus Fund","Aradgaon Rahuri Ashram Corpus Fund"];
	...
	function checkValidateAllFields(){
		...
		//errorFlag=false;
		if(checkFirstName() && checkLastName() && checkMobile() && checkEmail() && checkCity() && checkPIN() && checkPan() && checkAadhaar() && checkPaymentFor() &checkPaymentToward() && checkAmount()){
		...
		errorFlag=checkFirstName();
		
		if(!errorFlag){
			errorFlag=checkLastName();
		}
		if(!errorFlag){
			errorFlag=checkEmail();
			//alert('after email id check:'+localErrorFlag);		
		}		
		
		if(!errorFlag){
			errorFlag=checkMobile();
		}
		
		if(!errorFlag){
			errorFlag=checkCity();
		}		
		//alert('after mobile no check:'+localErrorFlag);
		
		if(!errorFlag){
			errorFlag=checkPan();
			//alert('after aadhaar no check:'+localErrorFlag);
		}		
		if(!errorFlag){
			errorFlag=checkAadhaar();
			//alert('after aadhaar no check:'+localErrorFlag);
		}
		if(!errorFlag){
			errorFlag=checkPaymentFor();
			//alert('after email id check:'+localErrorFlag);		
		}	
		
		if(!errorFlag){
			errorFlag=checkPaymentToward();
			//alert('after email id check:'+localErrorFlag);		
		}			
		
		if(!errorFlag){
			errorFlag=checkAmount();
			//alert('after email id check:'+localErrorFlag);		
		}	
	...
	function checkMobile(){
		...
		if(!errorFlag){
			...
			alert('erorr flag value locked which is :'+errorFlag);
		}
