...
// die();
    ...
    //   $to = 'workpreeti6@gmail.com'; 
      ...
      $bcc = 'seminar.payments@thelifeeternaltrustmumbai.org,seminar.payments@sahajayogamumbai.org,seminar.registrations@outlook.com';
...
margin-left: 10px;
        font-size: 17px;">
            <h6>
            <b>Your payment for International Sahaja Yoga Seminar - 2022, Ganpatipule '.$payment_for.' is <b style="color:red">UNSUCCESSFUL</b>.  Please try again.</b>
            </h6>
