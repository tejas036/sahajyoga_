...
$subject = "[Success Payment Receipt for] International Sahaja Yoga Seminar Nirmal Nagari – 2023, Ganapatipule"; 
...
<div class="heading">
  ...
  font-size: 17px;">
      <h6><b>Your payment for International Sahaja Yoga Seminar Nirmal Nagari – 2023, Ganapatipule is SUCCESSFUL as per below details</b></h6>
...
<table class="table table-bordered table-bg-color">
 <thead>
  ...
  <tr>
    <th style="text-align:left;">Contribute Towards</th>
    <td> '.$towards.'</td>
  </tr>

  <tr>
  <th style="text-align:left;">Payer\'s Name  </th>
...
<a
          ...
          "
          href="https://www.sahajayogamumbai.org/gpseminar/reprint-badges.php?trans_id='.$Transaction_id.'"
...
<div id="invoice">
    <center>
            <h5 style="text-align: center;">The Life Eternal Trust, Mumbai</h5>
            <h4 style="text-align: center;">International Sahaja Yoga Seminar Nirmal Nagari, Ganapatipule</h4>
            <h5 style="text-align: center;">December 22-26, 2023</h5>
            <h6 style="text-align: center;">Payment Receipt</h6>
