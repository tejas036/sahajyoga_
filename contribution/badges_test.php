...
$Unique_Ref_Number = '221129137457895';
    ...
    <div class="container-fluid" style="width: 99%">
      <div class="row print-hidden">
        <div class="col-md-12 text-center" style="padding: 15px 0px 10px 0px">
          <button class="btn btn-secondary" id="btn1" <?php echo "onclick=printDivMain('" . $trans_id . "')"; ?> >
            Print
          </button>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><?php 
                       ...
                       echo date_format($date,"jS F Y").' '.'03:24 pm';
                       ?></td>
                  </tr>
                  <tr>
