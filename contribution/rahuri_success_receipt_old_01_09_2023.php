...
$subject = "[Success Payment Receipt for] Maharashtra Yuva Shakti Seminar - 2023"; 
...
<div class="heading">
  ...
  font-size: 17px;">
      <h6><b>Your payment for Maharashtra Yuva Shakti Seminar - 2023 Aradgaon (Rahuri) '.$payment_for.' is SUCCESSFUL as per below details</b></h6>
...
<table class="table table-bordered table-bg-color" style="width:600px;">
 <thead>
  ...
  <tr>
  <th style="text-align:left">Participant Count </th>
  <td>'.$count_yuva.'</td>
  </tr>
  </tbody>
</table>
...
<a
          ...
          "
          href="https://www.sahajayogamumbai.org/nirmaldhamaradgaon/reprint-badges.php?trans_id='.$Transaction_id.'"
...
<div id="invoice">
    <center>
            <h2 style="text-align: center;">Maharashtra Yuva Shakti Seminar</h2>
            <h6 style="text-align: center;">The Life Eternal Trust, Mumbai</h6>
            <h6 style="text-align: center;">Nirmaldham Ashram, Aradgaon (Rahuri), Maharashtra</h6>
            <h6 style="text-align: center;">September 30th to October 2nd, 2023</h6>
